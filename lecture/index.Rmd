...
```{r, echo=FALSE}
for (i in list.files("../scripts", pattern="*\\.R$")) knitr::read_chunk(paste0("../scripts/", i))
```
...
library(plotrix)
data(soils)
triax.plot(soils[1:10,],show.grid=TRUE,show.legend=TRUE,col.symbols= rainbow(10),pch=10)
```
...
ls_venn <- list()
for (i in 1:4) ls_venn[[i]] <- floor(runif(100,0,150))
venn(ls_venn)
```
